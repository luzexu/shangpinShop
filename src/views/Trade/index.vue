...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      console.log('tradeNotradeNo', tradeNo)
      console.log(
        'this.orderInfo.detailArrayList',
        this.orderInfo.detailArrayList
      )
      console.log('datadatadata', data.orderDetailList)
      let result = await this.$API.reqSubmitOrder(tradeNo, data)
      console.log('resultresultresult', result)
      if (result.code == 200) {
        this.orderId = result.data
        return this.$router.push('/pay?orderId=' + this.orderId)
      } else {
